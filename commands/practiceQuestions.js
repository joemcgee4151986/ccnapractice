export const practiceQuestions = [
  {
    ...
    answeriosModes:"Access privileged exec mode by typing enable. Disable returns you to user exec mode. The line subconfiguration mode is accessed by typing" 
